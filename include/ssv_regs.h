...
#define ADDR_MRX_UTIL    ADR_MRX_WATCH_DOG
#define GET_MRX_MULTI_ADDR1 (((REG32(ADDR_MRX_UTIL))                      & 0x00000007 ) >> 0)
#define GET_MRX_TODS_MASK   (((REG32(ADDR_MRX_UTIL))                      & 0x00000008 ) >> 3)
#define SET_MRX_MULTI_ADDR1(__val__)    ((REG32(ADDR_MRX_UTIL))  = (((__val__)<<0)   |   ((REG32(ADDR_MRX_UTIL))                    & 0xfffffff8)))
#define SET_MRX_TODS_MASK(__val__)    ((REG32(ADDR_MRX_UTIL))  = (((__val__)<<3)   |   ((REG32(ADDR_MRX_UTIL))                    & 0xfffffff7)))
