...
//Security
#define drv_mac_get_pair_security()         GET_PAIR_SCRT
#define drv_mac_get_group_security()        GET_GRP_SCRT
#define drv_mac_set_pair_security(st)       SET_PAIR_SCRT(st)
#define drv_mac_set_group_security(gt)      SET_GRP_SCRT(gt)

#define drv_mac_set_security_pkt_id(id)     SET_SCRT_PKT_ID(id)
#define drv_mac_get_security_pkt_id()       GET_SCRT_PKT_ID
