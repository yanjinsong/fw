...
#define IRQ_ID_MNG_DMN_NOHIT				49		//R/W invalid address. For non-MCU hw to detect demand
...
#define IRQ_DMN_MCU_INT						56      //For MCU to detect demand
